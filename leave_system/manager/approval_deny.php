    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <?php
                        $approval = 2;
                        $sql = "SELECT id,empid,position,type,name,status_manager FROM leave2 WHERE approval = :approval AND boss=:session";
                    ...
                    <form  method="get">
                        <div class="form-group row pt-2">
                            <div class="col-10 col-sm-4">
                                <input type="text" name="id" class="form-control" placeholder="ค้นหาจากรหัสบัตรประชาชน13หลัก">
                            </div>
                        </div>
                        <div class="form-group row pt-2">                
                            <div class="col-10 col-sm-4">
                                <input type="text" name="name" class="form-control" placeholder="ค้นหาจากชื่อ">
                            </div>
                        </div>
                        <div class="form-group row pt-2">
                            <div class="col-10 col-sm-4">
                            ...
                            <div class="card shadow h-100 py-2" style="border:4px solid <?php echo $color ?>;border-radius:20px ">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fa-regular fa-circle-xmark" style="color: #ee2020; font-size:40px;"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
